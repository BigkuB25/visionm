					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="#"><div>Events</div></a>
								<li class="menu-item"><a class="menu-link" href="#"><div>About VisionM</div></a>
								<li class="menu-item"><a class="menu-link" href="#"><div>Careers</div></a>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-5 order-lg-12">
								<div class="device-xl device-md mt-6"></div>
								<h3 class="mb-0" style="font-size: 40px;">Great Team Work.</h3>
								<h3 class="fw-light ls-4 text-lowercase" style="font-size: 15px; color: #999;">Designed by Semicolonweb</h3>
								...
								<a href="#" class="button-link mb-5">Read More</a>
							</div>
							...
							<div class="col-lg-7 order-lg-1">
								<div style="position: relative; margin-bottom: 0;" class="overflow-hidden" data-height-xl="520" data-height-lg="520" data-height-md="520" data-height-sm="500" data-height-xs="300">
									<img class="man" src="{{ asset('images/sections/man.jpg') }}" style="position: absolute; top: 0; left: auto;" alt="Chrome">
								</div>
							</div>
